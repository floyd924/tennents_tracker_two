...
class MapPage extends Component {
  ...
  render(){
    ...
    const arrayOfAllPubsAndReviews = [
      ...
      {name: "The Chanter", latlng: [55.945691, -3.203956], price: 3.85, user: "Iain F", overall: 8, text: "Vessel: 9, classic, room temp. Head: 8, not too deep, slightly weak round the edges. Carbonation 10/10, perfect. Taste 8/10, its certainly juicy. Temperature 9/10, not too cold, but nice and chilled. Tidelines steps/10. Perfect juicy after a hard day coding a juicy tracking app.", imageurl: "https://scontent-lhr3-1.xx.fbcdn.net/v/t1.15752-9/49707145_2254639634859814_5540038878720688128_n.jpg?_nc_cat=109&_nc_ht=scontent-lhr3-1.xx&oh=d08d231a5664977263a8b8175bd96830&oe=5CCD0B7F"},
